...
int main() {
    int i;
    char h = 3; 
    MessageBoxA(NULL, "HAPPY BIRDTHAY NGUYEN MINH QUAN", "HAPPY", MB_OK);
    system("cls");
    system("color f5");
    cout << "\t\t\tFrom: your TUAN\n";
    Sleep(500);
    Beep(523, 500);
    cout << "\t\t\tTo  : Person's NGUYEN_MINH_QUAN\n\n";
    Sleep(500);
    Beep(523, 500);
    cout << "\t\t";
    for (i = 0; i < 42; i++)
    ...
    Sleep(500);
    Beep(523, 500);
    cout << string(1, h) <<" " <<h << h <<" "<< "\t\t\t   __| " << h << "  15/06  " << h << " |__\n";
    tongSoTim += 5 + 2;
    ...
    Sleep(500);
    Beep(523, 500);
    cout << string(3, h) <<" "<<h<< "\t\t       | " << h << " " << h << " " << h << " " << h << " Q U A N " << h << " " << h << " " << h << " " << h << " |\n";
    tongSoTim += 5 + 8;
